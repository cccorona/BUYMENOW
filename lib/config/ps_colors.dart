...
class PsColors {
  ...
  static const Color _c_main_color = Color(0xFF64E0DD);
  static const Color _c_main_light_color = Color(0xFFFDEDDD); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFFCC7012);
